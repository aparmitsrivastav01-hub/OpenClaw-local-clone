...
import { type AgentConfig, type ActionLog, defaultAgentConfig } from "./types";
...
export class ToolExecutor {
    ...
    private resolveSafe(rel: string): string { //paths sahi karega
    ...
    private excluded(relPath: string): boolean { //kosni file andar leni h ya nahi leni 
    ...
    private assertNotExcluded(rel: string, op: string): void { //excluded to nahi  h file jo h
